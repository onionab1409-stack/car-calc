...
**P2.2 · Парсинг tks.ru** ⏳ ← СЛЕДУЮЩИЙ ПОДЭТАП
- Начал исследование, нашёл:
  - tks.ru/auto/calc — веб-калькулятор (нет публичного API)
  - github.com/markolofsen/tks-api — Python-библиотека (MIT лицензия!)
    - CustomsCalculator с формулами ЕТТ ЕАЭС
    - age groups: "new", "1-3", "3-5", "5-7", "over_7"
    - engine types: "gasoline", "diesel", "electric", "hybrid"
  - calcus.ru/rastamozhka-auto — альтернативный калькулятор
  - calc.tks.ru — API ТКС для юрлиц (платный?)
  - drom.ru/world/calculator — калькулятор Дрома
- **РЕШЕНИЕ:** Реализовать свои формулы ЕТТ ЕАЭС (на основе tks-api библиотеки), с fallback на парсинг tks.ru
- Нужно: исследовать формулы ЕТТ ЕАЭС для 3-5 лет, ставки, коэффициенты
...
**«Контекст перенесён. Продолжаем с подэтапа P2.2 — исследование парсинга tks.ru и формул ЕТТ ЕАЭС для расчёта таможни 3-5 лет. GitHub репо подключено. Продолжай.»**
